          ...
          return (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                  <Link to={`/home/${freak}/${item.cat}`}>
                    <button className="px-2 py-1 border border-gray-500 text-gray-300 rounded-md hover:bg-neutral-900">
              ...
              <div className="px-2 py-4">
                <div>
                  <h2 className="text-gray-300 mb-1">{generalTitle}</h2>
              ...
              {item.work_recommendation.filter((w) => w.type === 'prohibicion')
                ...
                <div className="px-2 py-4">
                  <div>
                    <h2 className="text-gray-300">{prohibicionTitle}</h2>
                    <ul className="list-disc list-inside text-gray-300">
                      {item.work_recommendation
