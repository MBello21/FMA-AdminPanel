...
export const useEdit = (initialData) => {
  ...
  const [editForm, setEditForm] = useState({
    ...
    work_recommendation_list: initialData.work_recommendation
      .filter((r) => r.type === 'precaucion')
      .map((r) => r.work_recommendation),
    prohibition_list: initialData.work_recommendation
  ...
  const handleSubmit = async (e, onSuccess) => {
    ...
    try {
      ...
      console.log('antes de onSuccess');
      onSuccess();
      console.log('después de onSuccess');
    } catch {
